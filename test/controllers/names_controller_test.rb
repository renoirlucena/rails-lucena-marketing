...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference("Name.count") do
      post names_url, params: { name: { address: @name.address, agent: @name.agent, cep: @name.cep, city: @name.city, description: @name.description, price: @name.price, state: @name.state } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { address: @name.address, agent: @name.agent, cep: @name.cep, city: @name.city, description: @name.description, price: @name.price, state: @name.state } }
